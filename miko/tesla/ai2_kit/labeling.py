...
from miko.tesla.ai2_kit.base import CllAnalyzer, CllTask
from miko.graph.plotting import canvas_style



class CllLabelingAnalyzer(CllAnalyzer):
    ...
    def fp_element_distance(self, iteration, ele_group, **kwargs):
        ...
        for i in task_files:
            if (i / _output_name).exists():
                dis_loc.append(i)
                stc = read(i / _output_name)
